...
redevelopment_areas <- st_read("https://data-phl.opendata.arcgis.com/datasets/80f2c71305f5493c8e0aab9137354844_0.geojson") %>%
  dplyr::filter(TYPE == 'Redevelopment Area Plan and Blight Certification' & STATUS == 'Active' & CORRESPREDEVPLAN != "Gray's Ferry (1968)/Point Breeze (2001)")%>%
  st_transform('EPSG:2272')
...
ggplot()+
  geom_sf(data=intersection, aes(fill=q5(trees_per_mi)))+
